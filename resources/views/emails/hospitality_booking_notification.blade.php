...
<html>
<head>
    <title>New Hospitality Booking Request</title>
</head>
<body>
    <h1>New Hospitality Booking Request</h1>
    <p>Dear {{ $vendor->vendor_name }},</p>
    <p>You have received a new booking request for your hospitality service. Here are the details:</p>
    ...
    <p>Please log in to your vendor dashboard to confirm or reject this booking request.</p>
